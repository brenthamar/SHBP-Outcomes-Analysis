...
satisfaction_level_change = Value_Last - Value_First;
...
proc sql;
create table LIFE_working_risk2_b as 
select a.*, b.cost as SIMM_value_risk
from LIFE_working_risk2 a left join Shbp_sim_costs_trans_final b
